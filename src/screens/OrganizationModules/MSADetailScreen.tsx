...
const ResourceDetailCard = ({ msaData }:any) => {
  const resource = msaData?.resource_datail || {};
    ...
    <ScrollView style={styles.ResourceDetailCardcontainer}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.profileSection}>
          <Image
            source={
              resource?.user_detail?.profile_pic
                ? { uri: resource.user_detail.profile_pic }
                : require("../../assets/images/user.png")
            }
            style={styles.profilePic}
          />
          <Text style={styles.name}>
            {resource?.user_detail?.first_name} {resource?.user_detail?.last_name}
          </Text>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statBox}>
            <Text style={styles.statValue}>{resource?.total_experience} Years</Text>
        ...
        <View style={styles.infoList}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>{resource?.user_detail?.contact_number}</Text>
          </View>
          <View style={styles.infoRow}>
            <Ionicons name="mail-outline" size={18} color="#555" />
            <Text style={styles.infoText}>{resource?.user_detail?.email}</Text>
          </View>
          <View style={styles.infoRow}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.skillsContainer}>
          {resource?.skill_set_data?.map((skill) => (
