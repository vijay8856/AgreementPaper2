// // ============================================================
// //  UpdateTalentProfileModal.tsx   (FINAL FULL FILE)
// // ============================================================
...
//     const [experience, setExperience] = useState(""); // e.g. 1 OR 1.2
//     const [jobTitle, setJobTitle] = useState("");

//     const [resumeFile, setResumeFile] = useState<any>(null); // PDF only
//     const [profilePic, setProfilePic] = useState<any>(null); // image only
...
//   return originalProfile?.[key] !== value;
// };
...
//     await Services.updateUserProfile(payload);
//   }
// };
...
//   if (isChanged("country_name", country)) fd.append("country_name", country);
//   if (isChanged("state_name", state)) fd.append("state_name", state);
//   if (isChanged("district", district)) fd.append("district", district);
//   if (isChanged("pin_code", pinCode)) fd.append("pin_code", pinCode);
//   if (isChanged("address", address)) fd.append("address", address);
//   if (isChanged("about", about)) fd.append("about", about);
...
//     originalProfile?.skills?.map((s) => s.id) || [];
...
//   if ([...fd.keys()].length > 0) {
//     await Services.updateTalentUserProfile(fd);
//   }
// };
...
//                             {/* PROFILE IMAGE */}
//                             <TouchableOpacity onPress={pickProfileImage} style={styles.picContainer}>
//                                 {profilePic ? (
//                                     <Image source={{ uri: profilePic.uri }} style={styles.profilePic} />
//                                 ) : (
//                                     <Text style={{ color: "#666" }}>Upload Profile Picture</Text>
//                                 )}
//                             </TouchableOpacity>
...
//                             <TextInput
//                                 style={styles.input}
//                                 placeholder="Total Experience (e.g. 1 OR 1.2)"
//                                 value={experience}
...
//     await updateBasicProfile();
//   } catch (e) {
//     Toast.show({ type: "error", text1: "Basic profile update failed" });
//     setLoading(false);
//     return;
//   }
...
//   } catch (e) {
//     talentFailed = true;
//     console.log("Talent profile error:", e);
//   }
...
//     Toast.show({
//       type: "error",
//       text1: "Profile updated partially",
//       text2: "Some fields could not be saved",
//     });
//   } else {
//     Toast.show({
//       type: "success",
