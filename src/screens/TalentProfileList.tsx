    ...
    const renderItem = ({ item }: { item: TalentProfile }) => {
        ...
        return (
            <View style={styles.card}>
                ...
                {/* Experience */}
                <Text style={styles.meta}>💼 Experience: {item.total_experience} yrs</Text>
            ...
            <Modal visible={showAvailability} transparent animationType="fade">
                ...
                >
                    <View style={styles.modalBox}>
                        {[{ label: "Available", value: 1 }, { label: "Busy", value: 2 }].map(item => (
                            <TouchableOpacity
                                key={item.value}
                                style={styles.option}
                                onPress={() => {
                            ...
                            selectedIndividual && (
                                <>
                                    ...
                                    {selectedIndividual.cv && (
                                        <TouchableOpacity onPress={() => Linking.openURL(selectedIndividual.cv)}>
                                            <Text style={styles.cvLink}>📄 View CV</Text>
                                        </TouchableOpacity>
                                    )}
                                </>
                ...
                <View style={styles.modalContainer2}>
                    <View style={styles.modalContent}>
                        ...
                        {selectedIndividual && (
                            <>
                                <Text style={styles.modalTitle}>
                                    Connect with {selectedIndividual.user_detail.first_name} {selectedIndividual.user_detail.last_name}
                                </Text>
                                ...
                                <View style={styles.contactInfo}>
                                    <Text style={styles.contactText}>
                                        Or contact directly: {selectedIndividual.user_detail.contact_number || selectedIndividual.email || "N/A"}
                                    </Text>
                                </View>
                            </>
                        )}
