...
// import { View, Text, StyleSheet, Image, TouchableOpacity, ActivityIndicator,FlatList, Linking } from 'react-native';
...
//         const recipientNames = doc.recipients?.map((r: any) => r.name).filter(Boolean) || [];
//         return {
//           id: index + 1,
...
//       url: 'https://app.agreementpaper.site/organisation/esign',
//     });
//   }}
// >
//   <Text style={styles.buttonText}>Sign Document</Text>
...
//   renderItem={({ item }) => (
//     <View style={{ flexDirection: 'row', padding: 12, borderBottomWidth: 1, alignItems: 'center' }}>
