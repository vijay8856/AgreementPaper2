...
const LatestJobsScreen = ({navigation}: any) => {
  ...
  const handleSubmitApplication = async () => {
    ...
    if (!cvFile) return Alert.alert('Validation', 'Please upload CV (PDF)');
    ...
    if (!job_application_answers)
      return Alert.alert('validation', 'Please give answer of the question ');
