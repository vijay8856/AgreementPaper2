...
export const actsArray = [
  ...
  {
    value: 'competition-and-consumer-act',
    label: 'Competition and Consumer Act (Australian Consumer Law)',
  },
  {value: 'corporations-act', label: 'Corporations Act 2001'},
  {
    value: 'electronic-transactions-act',
    label: 'Electronic Transactions Act 1999 (Cth)',
  },
  {
    value: 'electronic-transactions-nsw',
    label: 'Electronic Transactions (New South Wales) Act 2000',
  },
  {
    value: 'electronic-transactions-vic',
    label: 'Electronic Transactions (Victoria) Act 2000',
  },
  {
    value: 'electronic-transactions-qld',
    label: 'Electronic Transactions (Queensland) Act 2001',
  },
  {
    value: 'electronic-transactions-wa',
    label: 'Electronic Transactions (Western Australia) Act 2011',
  },
  {
    value: 'electronic-transactions-sa',
    label: 'Electronic Transactions (South Australia) Act 2000',
  },
  {
    value: 'electronic-transactions-tas',
    label: 'Electronic Transactions (Tasmania) Act 2000',
  },
  {
    value: 'electronic-transactions-nt',
    label: 'Electronic Transactions (Northern Territory) Act 2000',
  },
  {value: 'privacy-act', label: 'Privacy Act 1988'},
  {
    value: 'australian-privacy-principles',
    label: 'Australian Privacy Principles',
  },
  {
    value: 'notifiable-data-breaches-scheme',
  ...
  {
    value: 'electronic-transactions-regulations',
    label: 'Electronic Transactions Regulations',
  },
  ...
  {
    value: 'cross-border-disclosure',
    label: 'APP 8 – Cross-border disclosure of personal information',
  },
  {value: 'eu-eidas-regulation', label: 'EU eIDAS Regulation'},
  {
    value: 'information-technology-act-india',
    label: 'Information Technology Act (India)',
  },
  {
    value: 'asic-apra-prudential-standards',
    label: 'ASIC & APRA Prudential Standards',
  },
  {value: 'my-health-records-act', label: 'My Health Records Act 2012'},
  {
    value: 'public-governance-act',
    label: 'Public Governance, Performance and Accountability Act 2013',
  },
  {
    value: 'national-electricity-law',
    label: 'National Electricity Law & AER Guidelines',
  },
